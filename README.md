...
- [langgenius/dify](https://github.com/langgenius/dify) ([1.4.2](https://github.com/langgenius/dify/releases/tag/1.4.2), 4 days ago) - Production-ready platform for agentic workflow development.
- [AfterShip/clickhouse-sql-parser](https://github.com/AfterShip/clickhouse-sql-parser) ([v0.4.10](https://github.com/AfterShip/clickhouse-sql-parser/releases/tag/v0.4.10), 5 days ago) - ClickHouse SQL Parser writing in Go
