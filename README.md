...
- [langgenius/dify](https://github.com/langgenius/dify) ([1.0.1](https://github.com/langgenius/dify/releases/tag/1.0.1), 3 days ago) - Dify is an open-source LLM app development platform. Dify&#39;s intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
...
- [Codium-ai/gradle-cover-agent](https://github.com/Codium-ai/gradle-cover-agent) - The Gradle Cover Agent Plugin is designed to help you increase code coverage in your Java projects. It integrates with Gradle to provide tasks that can be configured to run code coverage tools and report the results. (1 day ago)
- [qodo-ai/qodo-ci](https://github.com/qodo-ai/qodo-ci) - Increase your code coverage (1 day ago)
...
- [loglayer/loglayer](https://github.com/loglayer/loglayer) - A modern logging library for Javascript that routes logs to various logging libraries, cloud providers, and OpenTelemetry while providing a fluent API for specifying log messages, metadata and errors. (2 days ago)
