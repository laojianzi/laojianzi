...
- [kubernetes-sigs/cluster-api-provider-azure](https://github.com/kubernetes-sigs/cluster-api-provider-azure) ([v1.0.0-rc.0](https://github.com/kubernetes-sigs/cluster-api-provider-azure/releases/tag/v1.0.0-rc.0), 3 days ago) - Cluster API implementation for Microsoft Azure
- [oam-dev/kubevela](https://github.com/oam-dev/kubevela) ([v1.1.7](https://github.com/oam-dev/kubevela/releases/tag/v1.1.7), 4 days ago) - The Modern Application Delivery Platform.
