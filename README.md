...
- [oam-dev/kubevela](https://github.com/oam-dev/kubevela) ([v1.1.8](https://github.com/oam-dev/kubevela/releases/tag/v1.1.8), 3 days ago) - The Modern Application Delivery Platform.
- [kubernetes-sigs/cluster-api-provider-azure](https://github.com/kubernetes-sigs/cluster-api-provider-azure) ([v1.0.0](https://github.com/kubernetes-sigs/cluster-api-provider-azure/releases/tag/v1.0.0), 5 days ago) - Cluster API implementation for Microsoft Azure
