...
- [open-telemetry/opentelemetry-go-contrib](https://github.com/open-telemetry/opentelemetry-go-contrib) ([v1.8.0](https://github.com/open-telemetry/opentelemetry-go-contrib/releases/tag/v1.8.0), 2 days ago) - Collection of extensions for OpenTelemetry-Go.
- [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) ([v0.3.2-rc1](https://github.com/clickvisual/clickvisual/releases/tag/v0.3.2-rc1), 2 days ago) - A light weight log and data visual analytic platform  for clickhouse.
...
- [fix: service ports are consistent with deployment](https://github.com/clickvisual/clickvisual/pull/414) on [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) (2 weeks ago)
