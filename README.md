...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.121.0-pre](https://github.com/zed-industries/zed/releases/tag/v0.121.0-pre), today) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [skyzh/mini-lsm](https://github.com/skyzh/mini-lsm) - A tutorial of building an LSM-Tree storage engine in a week! (today)
