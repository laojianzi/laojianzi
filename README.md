...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.167.1-pre](https://github.com/zed-industries/zed/releases/tag/v0.167.1-pre), 2 days ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
- [langgenius/dify](https://github.com/langgenius/dify) ([0.14.1](https://github.com/langgenius/dify/releases/tag/0.14.1), 3 days ago) - Dify is an open-source LLM app development platform. Dify&#39;s intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
...
- [lowlighter/mizu](https://github.com/lowlighter/mizu) - 🌊 Lightweight, intuitive, and customizable JS library that makes building powerful web apps a breeze! (1 day ago)
- [xlzd/gotp](https://github.com/xlzd/gotp) - Golang OTP(One-Time Password) Library. (3 days ago)
- [pquerna/otp](https://github.com/pquerna/otp) - TOTP library for Go (3 days ago)
...
- [altence/lightence-ant-design-react-template](https://github.com/altence/lightence-ant-design-react-template) - Free and easy-to-use admin template based on React 17&#43; (4 days ago)
