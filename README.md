...
- [kubernetes-sigs/cluster-api-provider-azure](https://github.com/kubernetes-sigs/cluster-api-provider-azure) ([v0.5.3](https://github.com/kubernetes-sigs/cluster-api-provider-azure/releases/tag/v0.5.3), 1 day ago) - Cluster API implementation for Microsoft Azure
- [oam-dev/kubevela](https://github.com/oam-dev/kubevela) ([v1.1.3](https://github.com/oam-dev/kubevela/releases/tag/v1.1.3), 5 days ago) - The Modern Application Delivery Platform.
