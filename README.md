...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.133.2-pre](https://github.com/zed-industries/zed/releases/tag/v0.133.2-pre), 1 day ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [DefectDojo/django-DefectDojo](https://github.com/DefectDojo/django-DefectDojo) -  DevSecOps, ASPM, Vulnerability Management. All on one platform. (today)
- [xline-kv/Xline](https://github.com/xline-kv/Xline) - A geo-distributed KV store for metadata management (today)
