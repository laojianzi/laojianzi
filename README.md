...
- [longbridge/gpui-kit](https://github.com/longbridge/gpui-kit) ([v0.6.0](https://github.com/longbridge/gpui-kit/releases/tag/v0.6.0), 1 day ago) - Rust GUI components for building fantastic cross-platform desktop application by using GPUI.
- [laojianzi/omarchy-hosts-plugin](https://github.com/laojianzi/omarchy-hosts-plugin) ([v1.0.1](https://github.com/laojianzi/omarchy-hosts-plugin/releases/tag/v1.0.1), 2 days ago) - Native, keyboard-first /etc/hosts profile manager for Omarchy 4
...
- [facebook/astryx](https://github.com/facebook/astryx) - An open source design system that&#39;s fully customizable and agent ready (2 days ago)
