...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.150.0-pre](https://github.com/zed-industries/zed/releases/tag/v0.150.0-pre), 2 days ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [eythaann/Seelen-UI](https://github.com/eythaann/Seelen-UI) - The Fully Customizable Desktop Environment for Windows 10/11 with a windows tiling manager included. (2 days ago)
