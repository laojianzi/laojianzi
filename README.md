...
- [google/osv-scanner](https://github.com/google/osv-scanner) ([v2.3.8](https://github.com/google/osv-scanner/releases/tag/v2.3.8), today) - Vulnerability scanner written in Go which uses the data provided by https://osv.dev
...
- [coleam00/Archon](https://github.com/coleam00/Archon) - The first open-source harness builder for AI coding. Make AI coding deterministic and repeatable. (today)
- [dravr-ai/dravr-embacle](https://github.com/dravr-ai/dravr-embacle) - Rust library wrapping 12 AI CLI tools as pluggable LLM providers — with OpenAI API client, ACP headless mode, agent loop, MCP server, and OpenAI-compatible REST API (today)
