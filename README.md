...
- [langgenius/dify](https://github.com/langgenius/dify) ([0.7.0](https://github.com/langgenius/dify/releases/tag/0.7.0), 5 days ago) - Dify is an open-source LLM app development platform. Dify&#39;s intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
