...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.128.1-pre](https://github.com/zed-industries/zed/releases/tag/v0.128.1-pre), 2 days ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [jkstack/libagent](https://github.com/jkstack/libagent) - agent封装类库，用于快速开发agent (1 day ago)
