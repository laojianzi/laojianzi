...
- [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) ([v0.4.5-rc1](https://github.com/clickvisual/clickvisual/releases/tag/v0.4.5-rc1), 2 days ago) - A lightweight log analytic and data visualize platform  built on clickhouse.
...
- [fix: trim suffix /api/v2/alerts for alertmanager url](https://github.com/clickvisual/clickvisual/pull/808) on [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) (2 days ago)
- [refactor: the alertmanager url fetch](https://github.com/clickvisual/clickvisual/pull/807) on [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) (2 days ago)
