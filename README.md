...
- [langgenius/dify](https://github.com/langgenius/dify) ([0.13.1](https://github.com/langgenius/dify/releases/tag/0.13.1), today) - Dify is an open-source LLM app development platform. Dify&#39;s intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.165.1-pre](https://github.com/zed-industries/zed/releases/tag/v0.165.1-pre), today) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
