...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.139.0-pre](https://github.com/zed-industries/zed/releases/tag/v0.139.0-pre), 1 day ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [lapce/floem](https://github.com/lapce/floem) - A native Rust UI library with fine-grained reactivity (3 days ago)
