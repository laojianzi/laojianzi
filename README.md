...
- [google/osv-scanner](https://github.com/google/osv-scanner) ([v2.3.0](https://github.com/google/osv-scanner/releases/tag/v2.3.0), 3 days ago) - Vulnerability scanner written in Go which uses the data provided by https://osv.dev
- [flowershow/obsidian-flowershow](https://github.com/flowershow/obsidian-flowershow) ([3.0.7](https://github.com/flowershow/obsidian-flowershow/releases/tag/3.0.7), 4 days ago) - Obsidian Flowershow plugin for publishing with Flowershow direct from your obsidian vault.
