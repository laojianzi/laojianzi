...
- [lassejlv/skills](https://github.com/lassejlv/skills) - A collection of personal skills  (2 days ago)
- [NousResearch/Hermes-Bot-Mode](https://github.com/NousResearch/Hermes-Bot-Mode) - Bot Mode for the Hermes desktop: a roster of named agents with their own chats, avatars, routines, and bot-to-bot messaging. Desktop plugin, no core patches. (2 days ago)
...
- [ublue-os/bluefin](https://github.com/ublue-os/bluefin) - The next generation Linux workstation, designed for reliability, performance, and sustainability. (3 days ago)
- [gogpu/ui](https://github.com/gogpu/ui) - Pure Go GUI toolkit built on GoGPU — widgets, layouts, styling (3 days ago)
