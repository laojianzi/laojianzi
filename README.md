...
- [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) - A lightweight log analytic and data visualize platform  built on clickhouse. (4 days ago)
- [loggie-io/loggie](https://github.com/loggie-io/loggie) - A lightweight, cloud-native data transfer agent and aggregator (4 days ago)
...
- [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) ([v1.0.0-rc10](https://github.com/clickvisual/clickvisual/releases/tag/v1.0.0-rc10), 4 days ago) - A lightweight log analytic and data visualize platform  built on clickhouse.
...
- [fix: ensure the clickvisual UI port matches the doc](https://github.com/clickvisual/clickvisual/pull/1088) on [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) (4 days ago)
...
- [angular/angular](https://github.com/angular/angular) - The modern web developer’s platform (2 days ago)
...
- [cloudwego/thriftgo](https://github.com/cloudwego/thriftgo) - An implementation of thrift compiler in go language.  (3 days ago)
...
- [scratchdata/ScratchDB](https://github.com/scratchdata/ScratchDB) - Scratch is an open-source alternative to BigQuery, Redshift, and Snowflake. Runs on Clickhouse. (4 days ago)
