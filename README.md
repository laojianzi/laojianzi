...
- [laojianzi/omarchy-hosts-plugin](https://github.com/laojianzi/omarchy-hosts-plugin) - Native, keyboard-first /etc/hosts profile manager for Omarchy 4 (3 weeks ago)
...
- [longbridge/gpui-kit](https://github.com/longbridge/gpui-kit) ([v0.6.6](https://github.com/longbridge/gpui-kit/releases/tag/v0.6.6), 3 days ago) - Rust GUI components for building fantastic cross-platform desktop application by using GPUI.
...
- [yetone/magpie](https://github.com/yetone/magpie) - Every agent&#39;s model. One place. Codex on DeepSeek, Claude Code on Kimi, from the menu bar. (today)
- [nowledge-co/hawdb](https://github.com/nowledge-co/hawdb) -  (1 day ago)
- [Ephemeral-AI-Lab/layerfs](https://github.com/Ephemeral-AI-Lab/layerfs) - LayerFS gives every agent an isolated, disposable filesystem fork without copying the shared base. Useful states become durable, deduplicated checkpoints with workspace-scoped tool history—ready to branch, rewind, or reuse across parallel development, environment experiments, and MCTS-style rollouts. (1 day ago)
- [TencentCloud/Octop](https://github.com/TencentCloud/Octop) - A smarter, self-hosted AI assistant — multi-user, multi-agent. (4 days ago)
