...
- [gofrs/uuid](https://github.com/gofrs/uuid) - A UUID package for Go (4 days ago)
...
- [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) - Spec-driven development for AI coding assistants. (5 days ago)
