...
- [langgenius/dify](https://github.com/langgenius/dify) ([1.5.1](https://github.com/langgenius/dify/releases/tag/1.5.1), 6 days ago) - Production-ready platform for agentic workflow development.
...
- [AfterShip/clickhouse-sql-parser](https://github.com/AfterShip/clickhouse-sql-parser) ([v0.4.10](https://github.com/AfterShip/clickhouse-sql-parser/releases/tag/v0.4.10), 4 weeks ago) - ClickHouse SQL Parser writing in Go
...
- [greenbone/openvas-scanner](https://github.com/greenbone/openvas-scanner) - This repository contains the scanner component for Greenbone Community Edition. (today)
...
- [microsoft/edit](https://github.com/microsoft/edit) - We all edit. (1 week ago)
