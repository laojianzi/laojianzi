...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.138.6](https://github.com/zed-industries/zed/releases/tag/v0.138.6), 2 days ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
...
- [lapce/floem](https://github.com/lapce/floem) - A native Rust UI library with fine-grained reactivity (6 days ago)
- [air-verse/air](https://github.com/air-verse/air) - ☁️ Live reload for Go apps (6 days ago)
- [auxten/chdb-server](https://github.com/auxten/chdb-server) - Standalone chDB server by chdb-go (1 week ago)
