...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.165.3-pre](https://github.com/zed-industries/zed/releases/tag/v0.165.3-pre), 1 day ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
- [langgenius/dify](https://github.com/langgenius/dify) ([0.13.1](https://github.com/langgenius/dify/releases/tag/0.13.1), 2 days ago) - Dify is an open-source LLM app development platform. Dify&#39;s intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
...
- [mathiasbynens/dotfiles](https://github.com/mathiasbynens/dotfiles) - :wrench: .files, including ~/.macos — sensible hacker defaults for macOS (4 days ago)
- [coderabbitai/dotfiles](https://github.com/coderabbitai/dotfiles) - A modern Zsh/tmux, Vim and Homebrew centric setup for macOS and Linux (4 days ago)
