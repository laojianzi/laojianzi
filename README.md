...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.130.1-pre](https://github.com/zed-industries/zed/releases/tag/v0.130.1-pre), 3 days ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
- [loggie-io/loggie](https://github.com/loggie-io/loggie) ([v1.5.0](https://github.com/loggie-io/loggie/releases/tag/v1.5.0), 4 days ago) - A lightweight, cloud-native data transfer agent and aggregator
...
- [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore) - Modern UI for Ansible (5 days ago)
