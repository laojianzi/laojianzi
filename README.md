...
- [google/osv-scanner](https://github.com/google/osv-scanner) ([v2.3.2](https://github.com/google/osv-scanner/releases/tag/v2.3.2), 5 days ago) - Vulnerability scanner written in Go which uses the data provided by https://osv.dev
