...
- [open-telemetry/opentelemetry-go-contrib](https://github.com/open-telemetry/opentelemetry-go-contrib) ([v1.10.0](https://github.com/open-telemetry/opentelemetry-go-contrib/releases/tag/v1.10.0), today) - Collection of extensions for OpenTelemetry-Go.
